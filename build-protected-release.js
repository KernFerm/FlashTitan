...
try {
  ...
  console.error(
    "Missing dependency: javascript-obfuscator. Install it with `npm install --save-dev javascript-obfuscator` before running the protected build commands."
  );
  process.exit(1);
}
...
function main() {
  ...
  if (prepareOnly) {
    console.log(`Prepared protected release stage at ${stageDir}`);
    return;
  }

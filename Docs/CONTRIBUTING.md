...
- Preserve an explicit and easy-to-understand destructive-write warning before flashing
- Keep user-facing language kind and easy to understand
- Add or update tests when behavior changes
- Update the docs when workflows, release behavior, or UI wording change

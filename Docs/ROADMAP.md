...
- [x] Reduce the first screen to the three main actions:
  ...
  - choose USB drive
  - make bootable drive
- [x] Hide advanced fields behind a `Show Advanced` toggle
- [x] Hide checksum inputs unless the user asks for them or the preset requires them
- [x] Keep logs, support bundle tools, and help actions secondary to the main path
...
- [ ] Test `install.esd` export or split path
...
- [x] Add archive content preview before extraction
- [x] Stop and ask for manual unpacking when more than one flashable image is found
...
- [x] Add a non-destructive dummy-image smoke test for preflight coverage
...
- [x] failure recovery is strong
- [ ] release packaging feels polished and trustworthy
- [x] docs, installer, and safety messaging feel complete
